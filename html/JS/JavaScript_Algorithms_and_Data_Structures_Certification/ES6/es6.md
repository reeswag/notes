...
## Using get and set to control Object Properties
...
<b> Note: It is convention to precede the name of a private variable with an underscore (_). However, the practice itself does not make a variable private.</b>
...
The above code provides automatic conversion between Celcius and Fahrenheit when getting and setting a property. 
